...
+(CGSize)sizeForMessageModel:(RCMessageModel *)model withCollectionViewWidth:(CGFloat)collectionViewWidth referenceExtraHeight:(CGFloat)extraHeight{
    RCMessage *message = (RCMessage *)model.content;
    CGSize size = [ChatDetailCell getBubbleBackgroundViewSize:message];
...
- (void)initialize {
    //背景
//    self.messageContentView = [[UIImageView alloc] initWithFrame:CGRectZero];
...
/*
- (void)setAutoLayout {
    RCMessage *testMessage = (RCMessage *)self.model.content;
    if (testMessage) {
...
//+ (CGSize)getTextLabelSize:(RCMessage *)message {
