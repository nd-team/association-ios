...
- (CGFloat)height {
    ...
    for (int i = 0; i < _replyUsers.count; i++) {
        ...
        hei += [ImageUrl boundingRectWithString:[NSString stringWithFormat:@"%@回复%@:%@",model.nickname,model.fromNickname,model.content] width:(KMainScreenWidth-46) height:MAXFLOAT font:13].height;
