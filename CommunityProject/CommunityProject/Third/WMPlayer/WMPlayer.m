...
//    self.bottomView.backgroundColor = [UIColor colorWithWhite:0.4 alpha:0.4];
    ...
    self.progressSlider.minimumTrackTintColor = UIColorFromRGB(0xffffff);
    self.progressSlider.maximumTrackTintColor = [UIColor colorWithRed:124 green:124 blue:124 alpha:0.3];
